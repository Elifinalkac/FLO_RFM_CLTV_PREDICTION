...
from conda_build.convert import update_lib_path
from lifetimes import BetaGeoFitter
from xlwings.pro.udfs_officejs import background_tasks
...
# 3. "order_num_total_ever_online","order_num_total_ever_offline","customer_value_total_ever_offline","customer_value_total_ever_online" değişkenlerinin
#aykırı değerleri varsa baskılayanız.
baskilanacaklar = ["order_num_total_ever_online","order_num_total_ever_offline","customer_value_total_ever_offline","customer_value_total_ever_online"]

for b in baskilanacaklar:
    replace_with_thresholds(df, b)
